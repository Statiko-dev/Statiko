...
func (c *appConfig) bindEnvVars() {
	...
	viper.BindEnv("auth.auth0.clientId", "AUTH_AUTH0_CLIENT_ID")
	viper.BindEnv("auth.auth0.domain", "AUTH_AUTH0_DOMAIN")
	viper.BindEnv("auth.auth0.enabled", "AUTH_AUTH0_ENABLED")
	...
	viper.BindEnv("azureKeyVault.name", "AZURE_KEY_VAULT_NAME")
	viper.BindEnv("azureKeyVault.auth.tenantId", "AZURE_KEY_VAULT_AUTH_TENANT_ID")
	viper.BindEnv("azureKeyVault.auth.clientId", "AZURE_KEY_VAULT_AUTH_CLIENT_ID")
	viper.BindEnv("azureKeyVault.auth.clientSecret", "AZURE_KEY_VAULT_AUTH_CLIENT_SECRET")
