...
type StateStore struct {
	...
	Certificates map[string]*TLSCertificate `protobuf:"bytes,2,rep,name=certificates,proto3" json:"certificates,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	// DH parameters
	DhParams *DHParams `protobuf:"bytes,4,opt,name=dh_params,json=dhParams,proto3" json:"dh_params,omitempty"`
}
...
type TLSCertificate struct {
	...
	// Certificate name, version and data (used by certain types only)
	// Data is encrypted if present
...
func (x *TLSCertificate) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *TLSCertificate) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_state_store_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xd4, 0x01, 0x0a, 0x0e,
	0x54, 0x4c, 0x53, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x12, 0x30,
	0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x73,
	0x74, 0x61, 0x74, 0x69, 0x6b, 0x6f, 0x2e, 0x54, 0x4c, 0x53, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66,
	...
	0x74, 0x61, 0x22, 0x4e, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x55,
	...
	,
