# Based on: https://github.com/rcarmo/azure-pipelines-multiarch-docker
# Created by Rui Carmo - licensed under Apache2
export IMAGE_NAME?=italypaleale/statiko
export VCS_REF=`git rev-parse --short HEAD`
export VCS_URL="https://github.com/ItalyPaleAle/statiko"
