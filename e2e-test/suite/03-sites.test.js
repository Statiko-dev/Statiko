...
describe('Sites', function() {
    it('Create site 1', async function() {
        ...
        assert.deepStrictEqual(Object.keys(response.body).sort(), ['id', 'clientCaching', 'tlsCertificate', 'domain', 'aliases'].sort()) 
    ...
    it('List sites', async function() {
        ...
        for (let i = 0; i < response.body.length; i++) {
            ...
            assert(site)
            assert.deepStrictEqual(Object.keys(el).sort(), ['id', 'clientCaching', 'tlsCertificate', 'domain', 'aliases'].sort()) 
